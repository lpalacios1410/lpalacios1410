...
# 👋 ¡Hola! Soy Luis Palacios — ArmandoBits

Soy un desarrollador apasionado por construir soluciones web modernas y funcionales. Mi enfoque actual está en el ecosistema de **React, Node.js, Tailwind CSS y TypeScript**. Siempre en proceso de aprender nuevas tecnologías para adaptarme al mercado.

Aunque estoy en las primeras etapas de mi carrera profesional, llevo un año sumergido en el código, construyendo proyectos propios y aprendiendo de forma autodidacta cada día. Me gustaría especializarme en crear aplicaciones limpias y responsivas, priorizando siempre la experiencia del usuario y la claridad del código.

Busco oportunidades que no solo me permitan aportar valor a un negocio, sino que también me desafíen a seguir creciendo como profesional.

---

## 👋 Hello! I'm Luis Palacios — ArmandoBits

I'm a developer passionate about building modern and functional web solutions. My current focus is on the **React ecosystem, Node.js, Tailwind CSS, and TypeScript**. I'm always learning new technologies to adapt to the market.

Although I'm in the early stages of my professional career, I've been immersed in code for a year, building my own projects and learning on my own every day. I'd like to specialize in creating clean and responsive applications, always prioritizing user experience and code clarity.

I'm looking for opportunities that not only allow me to add value to a business but also challenge me to continue growing professionally.
...
![](https://github-readme-stats.vercel.app/api?username=lpalacios1410&theme=dark&hide_border=false&include_all_commits=true&count_private=true)
![](https://nirzak-streak-stats.vercel.app/?user=lpalacios1410&theme=dark&hide_border=false)
...
![](https://visitcount.itsvg.in/api?id=lpalacios1410&icon=0&color=0)
